	...
	def plant_low_value():
		...
		while num_items(Items.Power) < target_items:
			...
			while field.value[pos] != lowest_value: # Theoretically this could fail if we are EXTREMELY unlucky
				# TODO: We do not care about field.value right now. We could just use measure and actions directly
				# Do a benchmark withouth field.action and field.value to see the impact.
				# I suspect the update_growing call, while fast, still costs a lot in this context
